	...
	if (mDet.promotions.length == 0) {
		...
		for (var ii = 0, nnew = nnew, subs = subs; ii < mDet.promotions.length; ++ii) {
			...
			$('.merchPromo').append('<li class="avatar bits-max promo-collection ">' +
						...
						' waves-effect waves-light " style="padding: 2px;margin-left: 20px;margin-top: -10px;"><span style=" color: '+ mDet.promotions[ii].theme +' !important;margin: 10px 0px;border: 2px solid '+ mDet.promotions[ii].theme +';padding: 2px 10px;border-radius: 20px;">Buy</span></a><div class="switch " style="width: 190px;margin-top: -5px;float: right;"><i class="mdi-action-redeem"></i> <span style="" class="promoSubState-' + mDet.promotions[ii].id + 
