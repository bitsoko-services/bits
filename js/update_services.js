...
$(".merchantsPromotions").removeClass("displayNone")
		 ...
		 $('.merchPromo').append('<li class="avatar bits-max promo-collection">'+
						 '<a href="#" class="burst-12 btn-floating btn-large btn-price waves-effect waves-light  bits accent-2">'+mDet.promotions[ii].discount+'</a><img src="https://bitsoko.io'+mDet.promotions[ii].promoBanner+'" style="margin-top: ;" data-caption="'+mDet.promotions[ii].promoName+'" alt="'+mDet.promotions[ii].promoDesc+'" class="materialboxed">'+
           ...
           if( mDet.promotions[ii].discount == 0 || mDet.promotions[ii].discount.includes('null'))	{ $(".burst-12").addClass("displayNone");}
