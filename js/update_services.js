...
function populateService(mDet) {
    ...
    if (mDet.owner == parseInt(localStorage.getItem('bits-user-name'))) {
        ...
        $('.manage-store').html("")
        $('.manage-store').append('<a  style="background: none; float:right; !important; margin-top: ;" href="../soko/#s=' + parseInt(getBitsWinOpt('s')) + '" class="noshadow btn-large waves-effect waves-light "><i class="mdi-action-store" style="margin: 0 10px;"></i></a>');
    } else {
