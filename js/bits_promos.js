...
function subscribedPromos() {
    ...
    spromo.onsuccess = function (event) {
        try {
            ...
            console.log("no Promos subscribed")
            $('.promoHolder-home').html('')
